        ...
        <div className='relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full pt-28 pb-32'>
          ...
          <div className='flex items-end gap-10'>
            <div className='max-w-2xl'>
              ...
              >
                <img src='/profile/ephraim-crop.jpg' alt='Ephrem Orodi' className='w-8 h-8 rounded-full object-cover' />
                <span className='text-[13px] font-medium text-white/85 group-hover:text-white transition-colors' style={{ fontFamily: 'DM Sans, sans-serif' }}>Meet Ephrem, your session host</span>
